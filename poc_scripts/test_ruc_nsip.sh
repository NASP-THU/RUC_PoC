...
sleep 5
echo "Tesing BIND resolver against ruc_nsip..."
...
docker restart ruc-nameserver
sleep 5
echo "Tesing PowerDNS resolver against ruc_nsip..."
...
docker restart ruc-nameserver
sleep 5
echo "Tesing Unbound resolver against ruc_nsip..."
...
docker restart ruc-nameserver
sleep 5
echo "Tesing Knot resolver against ruc_nsip..."
...
docker restart ruc-nameserver
sleep 5
echo "Tesing Technitium resolver against ruc_nsip..."
