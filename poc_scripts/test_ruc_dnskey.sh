...
docker restart ruc-nameserver
sleep 5
echo "Tesing PowerDNS resolver against ruc_dnskey (w/o SIG)..."
...
docker restart ruc-nameserver
sleep 5
echo "Tesing PowerDNS resolver against ruc_dnskey (w/ SIG)..."
docker restart ruc-powerdns
...
docker restart ruc-nameserver
sleep 5
echo "Tesing Unbound resolver against ruc_dnskey (w/o SIG)..."
...
docker restart ruc-nameserver
sleep 5
echo "Tesing Unbound resolver against ruc_dnskey (w/ SIG)..."
docker restart ruc-unbound
...
docker restart ruc-nameserver
sleep 5
echo "Tesing Knot resolver against ruc_dnskey (w/o SIG)..."
...
docker restart ruc-nameserver
sleep 5
echo "Tesing Knot resolver against ruc_dnskey (w/ SIG)..."
docker restart ruc-knot
...
docker restart ruc-nameserver
sleep 5
echo "Tesing Technitium resolver against ruc_dnskey (w/o SIG)..."
...
docker restart ruc-nameserver
sleep 5
echo "Tesing Technitium resolver against ruc_dnskey (w/ SIG)..."
docker restart ruc-technitium
