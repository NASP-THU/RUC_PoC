...
sleep 5
echo "Testing BIND resolver against ruc_edns0..."
...
docker restart ruc-nameserver
sleep 5
echo "Testing PowerDNS resolver against ruc_edns0..."
...
docker restart ruc-nameserver
sleep 5
echo "Testing Unbound resolver against ruc_edns0..."
...
docker restart ruc-nameserver
sleep 5
echo "Testing Knot resolver against ruc_edns0..."
...
docker restart ruc-nameserver
sleep 5
echo "Testing Technitium resolver against ruc_edns0..."
